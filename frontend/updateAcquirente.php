...
<html>
	...
	<body>
		...
		<div class="container" style="display:flex;width:100%;">
    		<form method="POST" action="../backend/UpdateDatiAcquirente.php">
                <?php
                if (isset($_GET["status"]) && $_GET["status"] == 'ko') echo "<err>Data contain error(s)</err>";
                ?>
                    <div style="width:50%;" align="left">
                        <td>Name: </td><td><input type = "text" name = "nome" placeholder="Insert first name"></input></td>
                        <?php visualizzaErrore("nome"); ?>
                    </div>
                    <div style="width:50%;" align="left">
                        <td>Surname: </td><td><input type = "text" name = "cognome" placeholder="Insert surname"></input></td>
                        <?php visualizzaErrore("cognome"); ?>
                    </div>
                    <div style="width:50%;margin-left:0%;" align="left">
                        <td>Phone: </td><td><input type = "tel" name = "telefono" placeholder="Insert phone number"></input></td>
                    ...
                    <div style="width:100%;" align="left">
                        <td>Credit card: </td><td><input type = "number" name = "cartaCredito" placeholder="0000000000000000"></input></td>
                        <?php visualizzaErrore("carta"); ?>
                    </div>
                    <div style="width:50%;" align="left">
                        <td>Street: </td><td><input type = "text" name = "via" placeholder="Insert street"></input></td>
                        <?php visualizzaErrore("indirizzo"); ?>
                    </div>
                    <div style="width:50%;" align="left">
                        <td>House number: </td><td><input name="civico" placeholder="Insert number"></input></td>
                        <?php visualizzaErrore("indirizzo"); ?>
                    </div>
                    <div style="width:50%;" align="left">
                        <td>Zip code: </td><td><input type = "number" name = "cap" placeholder="Insert CAP"></input></td>
                        <?php visualizzaErrore("indirizzo"); ?>
                    </div>
                    <div style="width:50%;" align="left">
                        <td>Intercom: </td><td><input type = "text" name = "citofono" placeholder="Insert intercom"></input></td>
